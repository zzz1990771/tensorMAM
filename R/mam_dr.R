...
mam_dr <- function(Y,X,method="BIC",ncv=10,K_index=NULL,r1_index=NULL,r2_index=NULL,r3_index=NULL,SABC=NULL,
  ...
  if(method=="BIC") fit_dr = mam_bic(Y,X,K_index,r1_index,r2_index,r3_index,S,A,B,C,degr,eps,max_step)
  if(method=="CV") fit_dr = mam_cv(Y,X,ncv,K_index,r1_index,r2_index,r3_index,S,A,B,C,degr,eps,max_step)
  return(fit_dr)
}